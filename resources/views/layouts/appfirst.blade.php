    ...
    <header>
        <nav class="flex items-center justify-between px-8 py-4 my-8">
            ...
            <div class="logo mx-auto">
                <a href="/"><img src="{{ asset('images/logo.jpg') }}" alt="logo" class="w-1/4 lg:w-1/6 mx-auto"></a>
            </div>
            
        </nav>
        <nav class="bg-custom-blue-header flex items-center xl:justify-between px-8 py-4 justify-around">

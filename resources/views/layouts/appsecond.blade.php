            ...
            <ul class="flex items-center gap-4">
                <li>
                    <details class="relative inline-block text-left">
                        <summary class="w-full bg-custom-blue-header border border-transparent shadow-sm py-4 px-4 inline-flex justify-center text-xl font-semibold text-white hover:bg-amber-600 focus:outline-none active:bg-orange-600 focus:ring-2 focus:ring-orange-700">
                            MANÈGES
                        </summary>
                ...
                <li ><a class="w-full bg-custom-blue-header border border-transparent shadow-sm py-4 px-4 inline-flex justify-center text-xl font-semibold text-white hover:bg-amber-600 focus:outline-none active:bg-orange-600 focus:ring-2 focus:ring-orange-700" href="/Réservation">RÉSERVATION</a></li>
                <li><a class="w-full bg-custom-blue-header border border-transparent shadow-sm py-4 px-4 inline-flex justify-center text-xl font-semibold text-white hover:bg-amber-600 focus:outline-none active:bg-orange-600 focus:ring-2 focus:ring-orange-700" href="/a_propos">A PROPOS</a></li>
                <li><a class="w-full bg-custom-blue-header border border-transparent shadow-sm py-4 px-4 inline-flex justify-center text-xl font-semibold text-white hover:bg-amber-600 focus:outline-none active:bg-orange-600 focus:ring-2 focus:ring-orange-700" href="/contact">CONTACT</a></li>
            </ul>
        </div>

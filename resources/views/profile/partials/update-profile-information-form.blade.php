<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" id="profileForm" class="mt-6 space-y-6">
        @csrf
        @method('patch')
        ...
        <div>
            ...
            <p id="name-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            ...
            <x-input-error class="mt-2" :messages="$errors->get('surname')" />
                <p id="surname-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            <x-input-label class="text-xl" for="compagny" :value="__('Entreprise :')" />
            <x-text-input id="compagny" name="compagny" type="text" class="mt-1 block w-full" :value="old('compagny', $user->compagny)" autofocus autocomplete="compagny" />
            <x-input-error class="mt-2" :messages="$errors->get('compagny')" />
            <p id="compagny-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            <x-input-label class="text-xl" for="street_number" :value="__('Numero de rue :')" />
            <x-text-input id="street_number" name="street_number" type="text" class="mt-1 block w-full" :value="old('street_number', $user->street_number)" autofocus autocomplete="address" />
            <x-input-error class="mt-2" :messages="$errors->get('street_number')" />
            <p id="street_number-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            ...
            <p id="street_name-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            ...
            <p id="postal_code-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            ...
            <p id="city-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            <x-input-label class="text-xl" for="country" :value="__('Pays :')" />
            <x-text-input id="country" name="country" type="text" class="mt-1 block w-full" :value="old('country', $user->country)" required autofocus autocomplete="address" />
            <x-input-error class="mt-2" :messages="$errors->get('country')" />
            <p id="country-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            ...
            <p id="phone_number-error" class="mt-2 text-red-500 font-semibold"></p>
        </div>
        <div>
            <x-input-label class="text-xl" for="email" :value="__('Email :')" />
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="old('email', $user->email)" required autocomplete="username" />
            <x-input-error class="mt-2" :messages="$errors->get('email')" />
            <p id="email-error" class="mt-2 text-red-500 font-semibold"></p>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button id="submitBtn">{{ __('Enregister') }}</x-primary-button>

...
<div class="flex justify-center my-4">
    <div class="w-2/3 bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="length" id="length" value="{{ old('length') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('length')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="width" id="width" value="{{ old('width') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('width')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <!-- Champ localisation du manège -->
                    <div class="mb-4">
                        <label for="street_number" class="block mb-2">Numéro de rue :</label>
                        <input type="text" name="street_number" id="street_number" value="{{ old('street_number') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('street_number')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="street_name" id="street_name" value="{{ old('street_name') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('street_name')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('postal_code')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="city" id="city" value="{{ old('city') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('city')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="country" id="country" value="{{ old('country', 'France') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('country')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    {{-- <div class="mb-4">
                        ...
                        <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('latitude')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="longitude" id="longitude" value="{{ old('longitude') }}" class="border rounded-md px-3 py-2 w-full">
                        @error('longitude')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div> --}}
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01" required class="border rounded-md px-3 py-2 w-full">
                        @error('price')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <div id="imageFields" class="mb-4">
                        ...
                        <input type="file" name="imageCreate[]" id="imageCreate" accept="image/*" multiple class="border rounded-md px-3 py-2 w-full">
                        @error('imageCreate')
                            <p class="text-red-500 bg-red-100 p-2 rounded">{{ $message }}</p>
                        @enderror
                    </div>
                    <button id="addImageField" type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Ajouter une autre image</button>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-4">
            <a href="{{ url('/carousel') }}" class="bg-green-500 text-white rounded-md px-4 py-2">Retour à la liste</a>
        </div>
        @endif
    </div>
</div>

        ...
        <div class="w-1/2 bg-white p-8 rounded-lg shadow-md">
            ...
            <form method="POST" action="{{ url('carousel/update/'.$carousel->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="localization" id="localization" value="{{ $carousel->localization }}"
                        class="border rounded-md px-3 py-2 w-full">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="install_time" id="install_time" value="{{ $carousel->install_time }}"
                        class="border rounded-md px-3 py-2 w-full">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" value="{{ $carousel->price }}" name="price" id="price" step="0.01"
                ...
                <button type="submit"
                    class="bg-green-500 hover:bg-green-700 active:bg-green-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Enregistrer</button>
            </form>

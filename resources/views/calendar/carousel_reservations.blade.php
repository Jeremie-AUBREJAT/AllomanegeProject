...
@section('title', 'Réservations du manège')
@section('content')
    <div class="container mx-auto">
        <h2 class="text-3xl font-semibold my-4 ml-2">Réservations du Manège: "{{ $carousel->name }}"</h2>
        <div>
            
            @if ($reservations->isEmpty())
    <p class="text-xl font-bold my-36 ml-2">Aucune réservation disponible.</p>
@else
